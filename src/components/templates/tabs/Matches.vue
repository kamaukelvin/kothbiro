<template>
  <div>
    <div v-for="item in fixtures" :key="item.key">
      <h1>{{ item.data }}</h1>
    </div>
    <v-card
    ...
    >
      <v-list-item two-line>
        <v-list-item-content class="row">
          ...
          <div class="col-8">
            <v-list-item-subtitle @click="navigate('team')"
              >Digo United<span class="float-right"
                >2</span
              ></v-list-item-subtitle
            >
            <v-list-item-subtitle
              >Dallas All Stars<span class="float-right"
                >2</span
              ></v-list-item-subtitle
            >
          </div>
